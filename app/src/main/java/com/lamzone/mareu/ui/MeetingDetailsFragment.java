...
public class MeetingDetailsFragment extends Fragment {
    ...
    private void initData() {
        ...
        mBinding.dateInput.setText(MeetingDateTimeHelper.dateToString(meeting.getStart().toLocalDate()));
        mBinding.startTimeInput.setText(MeetingDateTimeHelper.dateTimeToTimeString(meeting.getStart()));
        mBinding.endTimeInput.setText(MeetingDateTimeHelper.dateTimeToTimeString(meeting.getEnd()));
